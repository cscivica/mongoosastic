...
import { CountResponse, IndicesCreateRequest, IndicesRefreshResponse, MappingProperty, MappingTypeMapping, PropertyName, QueryDslQueryContainer, SearchHighlight, SearchHit, SearchHitsMetadata, SearchRequest, SearchResponse } from '@elastic/elasticsearch/api/types';
...
export { BulkIndexOptions, BulkInstruction, BulkOptions, BulkUnIndexOptions, DeleteByIdOptions, EsSearchOptions, GeneratedMapping, HydratedSearchResults, IndexMethodOptions, MongoosasticDocument, MongoosasticModel, Options, SynchronizeOptions, };
