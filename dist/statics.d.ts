...
export declare function createMapping(this: MongoosasticModel<MongoosasticDocument>, body: IndicesCreateRequest['body'] | 'attachElasticSearch'): Promise<Record<PropertyName, MappingProperty>>;
